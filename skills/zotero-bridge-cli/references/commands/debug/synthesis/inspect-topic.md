...
```json
{
  ...
  "properties": {
    ...
    "capability": {
      "const": "debug.synthesis.topic.inspect"
    },
    "data": {
      "additionalProperties": true,
...
- Output boundary: `limit`; governed details: {"defaultLimit":25,"fileField":"data.delivery.bundle","maxLimit":100,"section":"data.discoveryHints","strategy":"limit","truncatedField":"data.truncated"}.
- Pagination: `none`.
