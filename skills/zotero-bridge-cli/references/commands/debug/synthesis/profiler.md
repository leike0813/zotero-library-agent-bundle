...
```json
{
  ...
  "properties": {
    ...
    "data": {
      "type": "object",
      "description": "Result data owned by debug.synthesis.profiler.list.",
...
```json
{
  "command": "debug synthesis profiler",
  "argv": [
    "debug",
    "synthesis",
    "profiler"
  ],
  "summary": "List debug-only Synthesis profiler timings",
  "category": "debug",
  "danger": "none",
  "invocationSchema": {
    "type": "object",
  ...
  "targets": [
    {
      "kind": "capability",
      "target": "debug.synthesis.profiler.list"
    }
  ],
  "operationalAliases": [
...
- Output boundary: `limit`; governed details: {"strategy":"limit","section":"data.runs","defaultLimit":25,"maxLimit":100,"truncatedField":"data.truncated","fileField":"data.delivery.bundle"}.
- Pagination: `none`.
