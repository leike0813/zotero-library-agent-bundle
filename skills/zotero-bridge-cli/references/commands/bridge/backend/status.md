...
```console
zotero-bridge bridge backend status [--endpoint <ENDPOINT>] [--operation-id <ID>] [--profile <PATH>] [--schema] BACKEND_ID <BACKEND_ID>
```
...
| Token | Id | Kind | Required | Conditional requirement | Values / arity | Repeatable | Environment | Conflicts | Help |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| BACKEND_ID | backend_id | positional | yes | — | BACKEND_ID | no | — | — | Backend id |
...
- Canonical argv path: `bridge` `backend` `status`.
