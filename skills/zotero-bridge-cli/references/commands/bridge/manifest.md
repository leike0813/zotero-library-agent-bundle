...
```json
{
  ...
  "properties": {
    ...
    "response": {
      "additionalProperties": true,
      "description": "Response object returned by GET /bridge/v2/manifest.",
      "type": "object",
...
```json
{
  ...
  "summary": "Read the authenticated Zotero Bridge service manifest",
  "targets": [
    {
      "kind": "endpoint",
      "target": "GET /bridge/v2/manifest"
    }
  ]
}
```
...
- Output boundary: `cursor`; governed details: {"continuation":["nextCursor","hasMore","returned","total","limit"],"cursorInput":"cursor","defaultLimit":25,"maxLimit":100,"section":"capabilities","strategy":"cursor"}.
- Pagination: `cursor`.
