...
```console
zotero-bridge synthesis topic list [--endpoint <ENDPOINT>] [--operation-id <ID>] [--profile <PATH>] [--schema] [--query <JSON_OR_FILE>]
```
...
```json
{
  "command": "synthesis topic list",
  "argv": [
    "synthesis",
    "topic",
    "list"
  ],
  "summary": "List existing topic synthesis topics",
  "category": "read",
  "danger": "none",
  "invocationSchema": {
    "type": "object",
...
- Canonical argv path: `synthesis` `topic` `list`.
- Output boundary: `cursor`; governed details: {"strategy":"cursor","section":"data.topics","defaultLimit":25,"maxLimit":100,"cursorInput":"cursor","continuation":["data.nextCursor","data.hasMore","data.returned","data.total","data.limit"]}.
- Pagination: `cursor`.
- Category: `read`; danger: `none`.
- Intent visibility: `visible`.
- Operational aliases: `synthesis topic list`, `synthesis`, `topic`, `list`, `query`, `JSON_OR_FILE`.
