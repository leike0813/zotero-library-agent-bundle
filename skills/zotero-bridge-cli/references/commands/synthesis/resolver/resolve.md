...
- Output boundary: `cursor`; governed details: {"strategy":"cursor","section":"data.candidates","defaultLimit":25,"maxLimit":100,"cursorInput":"cursor","continuation":["data.nextCursor","data.hasMore","data.returned","data.total","data.limit"]}.
- Pagination: `cursor`.
