...
```console
zotero-bridge synthesis concept query [--endpoint <ENDPOINT>] [--operation-id <ID>] [--profile <PATH>] [--schema] [--query <JSON_OR_FILE>]
```
...
```console
zotero-bridge synthesis concept query --query '{}'
```
...
```json
{
  ...
  "binding": "passthrough",
  "category": "read",
  "command": "synthesis concept query",
  "composition": null,
  "danger": "none",
  "effects": [
    {
  ...
  "summary": "Query Synthesis Concept KB candidates",
  "targets": [
    {
      "kind": "capability",
      "target": "concepts.query"
    }
  ]
}
```
...
- Output boundary: `limit`; governed details: {"defaultLimit":25,"maxLimit":100,"section":"data.matches","strategy":"limit","truncatedField":"data.truncated"}.
- Pagination: `none`.
- Category: `read`; danger: `none`.
- Structured binding mode: `passthrough`.
- Intent visibility: `visible`.
- Operational aliases: `synthesis concept query`, `synthesis`, `concept`, `query`, `JSON_OR_FILE`.
