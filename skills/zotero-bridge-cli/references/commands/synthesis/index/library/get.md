...
```console
zotero-bridge synthesis index library get [--endpoint <ENDPOINT>] [--operation-id <ID>] [--profile <PATH>] [--schema] [--query <JSON_OR_FILE>]
```
...
```console
zotero-bridge synthesis index library get --query '{}'
```
