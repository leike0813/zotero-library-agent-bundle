...
```json
{
  ...
  "targets": [
    {
      "kind": "endpoint",
      "target": "GET /bridge/v1/tasks/active"
    }
  ],
  "operationalAliases": [
    "run active",
...
- Output boundary: `cursor`; governed details: {"strategy":"cursor","section":"tasks","defaultLimit":25,"maxLimit":100,"cursorInput":"cursor","continuation":["nextCursor","hasMore","returned","total","limit"]}.
- Pagination: `cursor`.
