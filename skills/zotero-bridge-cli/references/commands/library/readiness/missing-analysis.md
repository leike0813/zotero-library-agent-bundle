...
```console
zotero-bridge library readiness missing-analysis [--endpoint <ENDPOINT>] [--operation-id <ID>] [--profile <PATH>] [--schema] [--query <JSON_OR_FILE>]
```
...
```console
zotero-bridge library readiness missing-analysis --query '{}'
```
...
```json
{
  "command": "library readiness missing-analysis",
  "argv": [
    "library",
    "readiness",
    "missing-analysis"
  ],
  "summary": "List Zotero items missing literature-analysis generated artifacts",
  "category": "read",
  "danger": "none",
  "invocationSchema": {
    "type": "object",
...
- Canonical argv path: `library` `readiness` `missing-analysis`.
- Output boundary: `cursor`; governed details: {"strategy":"cursor","section":"data.items","defaultLimit":25,"maxLimit":100,"cursorInput":"cursor","continuation":["data.nextCursor","data.hasMore","data.returned","data.total","data.limit"]}.
- Pagination: `cursor`.
- Category: `read`; danger: `none`.
- Intent visibility: `visible`.
- Operational aliases: `library readiness missing-analysis`, `library`, `readiness`, `missing-analysis`, `query`, `JSON_OR_FILE`.
